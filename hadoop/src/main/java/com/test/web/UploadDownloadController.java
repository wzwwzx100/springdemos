...
public class UploadDownloadController {
	...
	public String uploadToHdfs(HttpServletRequest request, @RequestParam("file") MultipartFile file, String destPath)
	...
	public String downloadFromHdfs(HttpServletResponse res, String sourcePath) {
		try {
